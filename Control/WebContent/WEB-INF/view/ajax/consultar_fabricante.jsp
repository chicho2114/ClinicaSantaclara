	...
	<tbody>
			...
			<tr>
				...
				<td class="text-center">
					<form action="${pageContext.request.contextPath}/referencias/eliminar_fabricante">
						<input type=hidden name="codigo" value="${fabricante}" >
				...
				<td><a href="${pageContext.request.contextPath}/referencias/listar_reporte?codigo=&descripcion=&fabricante=${fabricante}&categoria="><img src="${pageContext.request.contextPath}/images/buscar.png" /></a></td>
			<tr>
