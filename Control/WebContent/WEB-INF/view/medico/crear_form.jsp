...
<c:choose>
	<c:when test="${!(UserRol eq ('[ROLE_NOUSUARIO]')) }">
				...
				<form action="${pageContext.request.contextPath}/medico/crear_accion" method="post"
					  id="crearMedico">
					<table class="table table-hover">
			       		...
			       		<tr>
			       			...
			       			<td><strong>Servicio en la clinica:</strong></td>
			       			<td><textarea class="uppercase" name="servicio" rows="2" cols="120" tabindex="4" required></textarea></td>
			       		</tr>
			       		<tr>
				...
				<form action="${pageContext.request.contextPath}/medico/buscar_cliente">
					<button class="btn btn-info" tabindex="6" type="submit">Buscar Medico <i class="icon-search"></i></button>
				</form>
					</c:when>
	<c:otherwise>
		<!-- Modal -->
